...
<body>	       <img src="../../img/image001.png" />   
    ...
    <div id="notas">
		<p>
			id del Curso: <span>7646</span>
			<br>
			Este curso esta asociado a un curso regular
			<br>
			Lista de Cursos: 7647,7268
		</p>
		
		<h3 class="blue">CURSOS:</h3>
		...
		<button class="btn btn-primary" type="button"> <i class="fa fa-book" aria-hidden="true"></i> Leer Notas SiNFO SHRCMRK</button><br><br>
		<button class="btn btn-primary" type="button"> <i class="fa fa-book" aria-hidden="true"></i> Leer Tutores SiNFO SHACRSE (iNB Historia Academica)</button><br><br>
		<button class="btn btn-primary" type="button"> <i class="fa fa-book" aria-hidden="true"></i> Leer Tutores SiNFO</button>
		<p class="bold">Leer desde la linea <input  class="form-control" type="text" /></p> 
    </div>
