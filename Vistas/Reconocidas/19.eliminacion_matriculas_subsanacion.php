...
<head>
    ...
    <title>SV : Eliminaci&oacute;n de Matriculas de SUBSANACi&oacute;N</title>
...
<body>        <img src="../../img/image001.png" />   	
	   <div id="notas">
			<h4 class="blue"><span>iNDUCCiON A CURSOS ViRTUALES 201620</span> - Eliminaci&oacute;n de Matrículas de SUBSANACi&oacute;N</h4>
			<p class="red">Este NO ES UN CURSO DE SUBSANACi&oacute;N</p>
			<p class="blue">Este m&oacute;dulo verifica si el alumno ha aprobado el Curso Regular y permite desmatricularlo de SUBSANACi&oacute;N</p>
	  
			<span class="span_insertar">LiSTA DE ALUMNOS QUE APROBARON EL CURSO REGULAR</span>
			<table id="tables">
	  ...
	  <div>
		<a type="button" class="btn btn-primary"><i class="fa fa-file-text-o" aria-hidden="true"></i> Desmatricular</a>
	  </div>
