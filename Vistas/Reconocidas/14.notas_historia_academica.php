...
<body>        <img src="../../img/image001.png" />   	
	...
	<div id="">
		...
		<p class="bold">Curso: <span class="blue">MMTR 201710 - Grupo A - Zonal San Martin </span></p>
		<p class="bold">Fecha de inicio (D/M/A): <span class="blue">05/03/2017</span></p>
		<p class="bold">iD del CURSO: <span class="blue">7778</span></p>
		<p>
			...
			<br>(Los checks en <span class="yellow">amarillo</span> indican que esa nota es candidata para pasar a Historia Academica).
			<br>(Las notas/estados de Historia Academica en <span class="gris">gris</span>indican que esa nota fue modificada directamente por un administrador).
			<br>(Los Alumnos que tiene Promedio Final Ponderado igual a cero, no pueden tener nota de Subsanaci&oacute;n (sombreada en <span class="celeste">celeste</span>), si la tuviesen esta no será tomada en cuenta y se considerará como cero.)</p>
	...
	<div id="notas">
		<a type="button" href="#" class="btn btn-primary">Pasar Notas Seleccionadas a Historia Academica <i class="fa fa-arrow-right" aria-hidden="true"></i></a> (Solo el administrador de SENATi ViRTUAL puede pasar notas))
	</div>
    ...
    <a href="#" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar a Calificaciones</a>
