...
<head>
    ...
    <title>SV : Eliminaci&oacute;n de Matriculas PRESENCiALES</title>
...
<body>
		...
		<div id="notas">
			<p class="blue"><span>iNDUCCiON A CURSOS ViRTUALES 201620</span> - Eliminaci&oacute;n de Matrículas Presenciales</p>
			<p class="red">Este NO ES UN CURSO PRESENCiAL</p>
			<p class="blue">Este m&oacute;dulo verifica si el alumno está matriculado en el curso padre</p>
	  
			<span class="span_insertar">LiSTA DE ALUMNOS QUE NO DEBERiAN ESTAR EN ESTE CURSO PRESENCiAL
			<table id="tables">
